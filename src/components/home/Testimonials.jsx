...
const TESTIMONIALS = [
  {
    ...
    quote: "CampusEats has completely changed how I eat on campus. No more standing in long queues! The food is always fresh and hot.",
    rating: 5,
    avatar: "PS",
  ...
  },
  {
    name: "Arjun Nair",
    role: "B.E. 2nd Year",
    quote: "The Butter Chicken Thali is unbeatable. Ordered it 15 times already this semester. CampusEats = best decision ever.",
    rating: 5,
    avatar: "AN",
    color: "bg-amber-500",
  },
